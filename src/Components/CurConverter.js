...
class CurConverter extends Component {
    state = {
        result: null,
        fromCurrency: "USD",
        toCurrency: "GBP",
    ...
    componentDidMount() {
      const cors = "https://cors-anywhere.herokuapp.com/"
        axios
            .get(cors + "http://api.openrates.io/latest")
            .then(response => {
    ...
    convertHandler = () => {
      const cors = "https://cors-anywhere.herokuapp.com/"
        ...
        if (this.state.fromCurrency !== this.state.toCurrency) {
            axios
                .get(cors + `http://api.openrates.io/latest?base=${this.state.fromCurrency}&symbols=${this.state.toCurrency}`)
                .then(response => {
